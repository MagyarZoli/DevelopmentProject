class A:
  ...
  def insert(self, index: int, object1):
    def get_node(self, index):
      current = self
      count = -1
      while current is not None:
  ...
  def modify(self, index: int, object1):
    def get_node(self, index):
      current = self
      count = -1
      while current is not None:
